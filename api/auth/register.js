...
<div style="max-width:620px;margin:32px auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08)">
  ...
  <div style="padding:40px">
    ...
    <div style="text-align:center;margin:0 0 32px">
      <a href="https://machmiles.com/pricing" target="_blank" rel="noopener noreferrer" style="display:inline-block;background:linear-gradient(135deg,#3B82F6,#8B5CF6);color:#fff;text-decoration:none;font-weight:700;font-size:15px;padding:14px 36px;border-radius:10px">👉 Upgrade whenever you're ready</a>
    </div>
